...
logger = logging.getLogger('relogin')
...
def main():
    ...
    st.set_page_config(page_icon="pages/images/BBF.ico", initial_sidebar_state="collapsed")
    remove_padding_from_top_bar()
    st.warning('You are successfully logged out...!')
    user = st.text_input("User name")
    password = st.text_input("Password", type="password")
    redirect = st.button("LOGIN AGAIN")
